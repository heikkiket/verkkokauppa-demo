...
INSERT INTO kayttajat (id, nimi, toimitusosoite, email, puhelin, salasana)
VALUES
(1, 'Terttu Testaaja', 'Testikatu 123, Oulu', 'terttu.testaaja@esimerkki.fi', '050 123 4567', '$2y$10$1gbR.p1COtcTihfU9SL30eRX5t5JMYPsLLVcie5wJ0w3z.nFXBBOa', 1), /* salasana */
(2, 'Pertti Kokeilija', 'Kokeilukatu 56, Kerava', 'pertti.kokeilija@esimerkki.fi', '044 876 5432', '$2y$10$kTA.hLAOlYMaPeS7d/Ovi.wRIBN8ZHeRSTgbQH7kya4v4Ee1YGbeG', 2), /* asdasd */
(3, 'Emilia Empijä', 'Lempokatu 87, Lempäälä', 'emilia.epailija@esimerkki.fi', '040 233 4556', '$2y$10$.dwvP.vXBhG99L/wPE9XZeBlQauSxA8HpEEs75UaPGi8zKZ1SCFzK', 2); /* kakkale */
